...
Route::any('/v1/article/:id','admin/article/delete');
Route::any('/v1/article','admin/article/add');
...
Route::post('/v1/tag/:id','admin/tag/delete');
Route::post('/v1/tag','admin/tag/add');
Route::get('/v1/tag/:id','admin/tag/edit');
